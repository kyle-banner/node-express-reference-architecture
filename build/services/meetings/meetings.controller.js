...
var MeetingsController = (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                this.router.get('/', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, this.meetingsService.getMeetings()];
                            case 1:
                                meetings = _a.sent();
                                res.send(meetings);
                                return [2];
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4, this.meetingsService.getMeetingById(req.params.id)];
                            case 1:
                                meeting = _a.sent();
                                res.send(meeting);
                                return [2];
                ...
                this.router.post('/', [
                    express_validator_1.body('employeeIds').isArray(),
                    express_validator_1.body('scheduledTime').isISO8601(),
                    express_validator_1.body('address.line1').isString(),
                    express_validator_1.body('address.city').isString(),
                    express_validator_1.body('address.state').isString(),
                    express_validator_1.body('address.zipCode').isNumeric(),
                ], function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                    var createdMeeting;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, this.meetingsService.createMeeting(req.body)];
                            case 1:
                                createdMeeting = _a.sent();
                ...
                this.router.put('/:id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                    var updateMeetingRequest, updatedMeeting;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                updateMeetingRequest = __assign(__assign({}, req.body), { id: req.params.id });
                                return [4, this.meetingsService.updateMeeting(updateMeetingRequest)];
                            case 1:
                                updatedMeeting = _a.sent();
                                if (updatedMeeting.previouslyExisted) {
                                    return [2, res.status(200).send(this.basePath + "/" + updatedMeeting.id)];
                                }
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4, this.meetingsService.deleteMeeting(req.params.id)];
                            case 1:
    ...
    MeetingsController = __decorate([
        ...
        __param(0, inversify_1.inject(types_1.TYPES.MeetingsService)),
        __metadata("design:paramtypes", [Object])
    ], MeetingsController);
    return MeetingsController;
}(controller_1.default));
exports.default = MeetingsController;
