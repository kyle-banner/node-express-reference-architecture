...
export class AddressOnUpdateCascade1599802054775 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "meeting" ADD CONSTRAINT "FK_0f700978535ef22db953d0c97d1" FOREIGN KEY ("addressId") REFERENCES "address"("id") ON DELETE NO ACTION ON UPDATE CASCADE`);
    }
